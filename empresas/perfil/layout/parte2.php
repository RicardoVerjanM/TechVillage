...
<footer class="main-footer" >
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024-2028 <a href="https://adminlte.io">Techvillage</a>.</strong> Todos los derechos reservados.
  </footer>
<!-- jQuery -->
...
<script src="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/dist/js/demo.js"></script>
