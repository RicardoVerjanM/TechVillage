...
include('../app/controllers/pedidos/controladorPedidosPendientesAdmin.php');
                                    ...
                                    <table id="example1" class="table table-striped table-hover">
                                        ...
                                        <tbody style="text-align: center">
                                            <?php foreach ($pedidos as $pedido) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <center>
                                                            ...
                                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalDenegar<?php echo $id_pedido; ?>">
                                                                Rechazar
                                                            </button>
                                                        </center>
                                                    </td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="background: green;">
                                                                <h5 class="modal-title" id="modalAprobarLabel" style="color:white;">Aceptar Pedido</h5>
                                                ...
                                                <!-- Modal Rechazar -->
                                                <div class="modal fade" id="modalDenegar<?php echo $id_pedido; ?>" tabindex="-1" aria-labelledby="modalDenegarLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header " style="background: red;">
                                                                <h5 class="modal-title" id="modalDenegarLabel" style="color:white;">Rechazar Pedido</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <p>¿Estás seguro de que deseas rechazar este pedido?</p>
                                                                <p>Aquí está el comprobante de pago:</p>
                                                                <?php if ($pedido['comprobante_pago']): ?>
                                                                    <img src="data:image/jpeg;base64,<?php echo base64_encode($pedido['comprobante_pago']); ?>" alt="Comprobante de Pago" class="img-fluid">
                                                                <?php else: ?>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                                <form action="../app/controllers/pedidos/controladorDenegarPago.php" method="post">
                                                                    <input type="hidden" name="id_pedido" value="<?php echo $id_pedido; ?>">
