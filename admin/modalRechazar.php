<!-- Modal rechazar -->
<div class="modal fade" id="modalRechazar<?php echo $id_solicitud; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background: red;">
                <h1 class="modal-title fs-5" id="exampleModalLabel" style="color: white;">Rechazar Solicitud</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="../app/controllers/solicitudes/controladorRechazarSolicitud.php" method="post">
                    ...
                    <div class="card-body" style="display: block;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($solicitud['rut'])) { ?>
                                        <a href="<?php echo 'http://localhost/www.TechVillage.com/app/ewgfwef'.$solicitud['rut']; ?>" class="btn btn-primary" download>Descargar PDF</a>
                                    <?php } else { ?>
                        ...
                        <hr>
                        <div class="form-group">
                            <p>¿Desea rechazar esta solicitud?</p>
